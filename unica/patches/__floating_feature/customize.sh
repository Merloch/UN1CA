...
SEC_FLOATING_FEATURE_GRAPHICS_CONFIG_GAME_DEFAULT_FRAMERATE=${TARGET_LCD_CONFIG_HFR_DEFAULT_REFRESH_RATE:-120}
SEC_FLOATING_FEATURE_GRAPHICS_CONFIG_GAMEBOOSTER_MORE_HEAT=50
